                    ...
                    {servicesdata.map((item, index) => {
                        ...
                        return(
                            <div className="group p-6 shadow dark:shadow-gray-700 rounded-md bg-white hover:bg-emerald-600/5 dark:bg-slate-900 dark:hover:bg-emerald-600/10 text-center transition-all duration-500" key={index}>
                                <div className="size-16 flex items-center justify-center mx-auto bg-emerald-600/5 group-hover:bg-emerald-600 dark:bg-emerald-600/10 dark:group-hover:bg-emerald-600 shadow dark:shadow-gray-700 rounded-lg transition-all duration-500 text-emerald-600 group-hover:text-white text-2xl">
                                    <Icon className=" "/>
                                </div>
                                ...
                                <div className="mt-4">
                                    ...
                                    <Link href="#" className="hover:text-emerald-600 font-medium transition-all duration-500 inline-flex items-center">Read More<FiArrowRight/></Link>
                                </div>
                            </div>
                        )
                    })}
