...
import {LuCircleDollarSign, FiArrowUpRight, FiMapPin, FiArrowRight} from '../assets/icons/vander'
                ...
                <div className="container md:mt-24 mt-16">
                        ...
                        {data.map((item, index) => (
                            <div className="group rounded-lg shadow hover:shadow-lg dark:shadow-gray-700 transition-all duration-500" key={index}>
                                ...
                                <div className="lg:flex items-center justify-between border-t border-gray-100 dark:border-gray-800 p-6">
                                    ...
                                    <p className="text-slate-400 lg:mt-0 mt-4 flex items-center"><LuCircleDollarSign className="text-[20px] text-emerald-600 me-1"/>{item.price}</p>
                                </div>
                                ...
                                <div className="px-6 py-2 bg-slate-50 dark:bg-slate-800 flex justify-between items-center">
                                    ...
                                    <span className=" me-1 text-slate-400 flex items-center"><FiMapPin className="text-[18px] text-slate-900 dark:text-white me-1"/>{item.Location}</span>
                                </div>
                            </div>
                        ))}
                    </div>
                    ...
                    <div className="grid md:grid-cols-12 grid-cols-1 mt-8">
                        <div className="md:col-span-12 text-center">
                            <Link href="/job-list-five" className="btn btn-link text-slate-400 hover:text-emerald-600 after:bg-emerald-600 duration-500 ease-in-out inline-flex items-center"> <span>See More Jobs</span><FiArrowRight/></Link>
                        </div>
                    </div>
                </div>
            </section>
