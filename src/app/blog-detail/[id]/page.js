...
export default function BlogDetail({params}) {
    ...
    const blogData = newsData.find((news)=>news?.id === parseInt(id));
    return (
        <>
            ...
            <section className="relative table w-full py-36 bg-top bg-no-repeat bg-cover" style={{backgroundImage:"url('/images/hero/bg.jpg')"}}>
                ...
                <div className="container" >
                    <div className="grid grid-cols-1 text-center mt-10">
                        <h3 className="md:text-3xl text-2xl md:leading-snug tracking-wide leading-snug font-medium text-white mb-3">{blogData?.headline}</h3>
                        ...
                        <ul className="list-none mt-6">
                            ...
                            <li className="inline-block text-white/50 mx-5"> <span className="text-white block">Date :</span> <span className="block">{blogData?.date}</span></li>
                    ...
                    <div className="grid md:grid-cols-12 grid-cols-1 gap-[30px]">
                        <div className="lg:col-span-8 md:col-span-6">
                            <div className="relative overflow-hidden rounded-md shadow dark:shadow-gray-800">
                                ...
                                <Image src={blogData?.image} alt="" width={0} height={0} sizes='100vw' style={{width:"100%", height:"auto"}}/>
