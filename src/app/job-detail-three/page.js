                    ...
                    <div className="grid md:grid-cols-12 grid-cols-1 gap-[30px]">
                        <div className="lg:col-span-4 md:col-span-6">
                            <div className="p-6 shadow dark:shadow-gray-700 rounded-md bg-white dark:bg-slate-900 sticky top-20">
                                <Image src="/images/company/lenovo-logo.png" className="rounded-full size-28 p-4 bg-white dark:bg-slate-900 shadow dark:shadow-gray-700" alt="" height={112} width={112}/>

                                <div className="md:ms-4 mt-4">
                                    <h5 className="text-xl font-semibold">Back-End Developer</h5>
                                    <div className="mt-1">
                                        <span className="text-slate-400 font-medium me-2  inline-flex items-center"><FaRegBuilding className="text-[18px] text-emerald-600 me-1"/><span>Lenovo pvt. ltd. </span></span>
                                        <span className="text-slate-400 font-medium me-2 inline-flex items-center"><FiMapPin className="text-[18px] text-emerald-600 me-1"/><i className="uil uil-map-marker text-[18px] text-emerald-600 me-1"></i><span> Beijing, China</span></span>
                                    </div>
                                </div>
                            </div>
                        </div>
