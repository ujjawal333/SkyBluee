                    ...
                    <div className="grid md:grid-cols-12 grid-cols-1 gap-[30px]">
                        <div className="lg:col-span-8 md:col-span-6">
                            <div className="md:flex items-center p-6 shadow dark:shadow-gray-700 rounded-md bg-white dark:bg-slate-900">
                                <Image src="/images/company/lenovo-logo.png" width={112} height={112} className="rounded-full size-28 p-4 bg-white dark:bg-slate-900 shadow dark:shadow-gray-700" alt="" />
                                ...
                                <div className="md:ms-4 md:mt-0 mt-6">
                                    ...
                                    <div className="mt-2">
                                        ...
                                        <span className="text-slate-400 font-medium me-2 inline-flex items-center"><FiMapPin className=" text-[18px] text-emerald-600 me-1"/><span>Beijing, China</span></span>
                                    </div>
                                </div>
                            </div>
