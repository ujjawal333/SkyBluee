                    ...
                    <div className="grid grid-cols-1">
                        <div className="md:flex justify-between items-center shadow dark:shadow-gray-700 rounded-md p-6 bg-white dark:bg-slate-900">
                            <div className="flex items-center">
                                <Image src="/images/company/skype.png" className="size-20 p-3 shadow dark:shadow-gray-700 rounded-md bg-slate-50 dark:bg-slate-800" alt="" width={80} height={80} />

                                <div className="ms-4">
                                    <h5 className="text-xl font-bold">Skype</h5>
                                    <h6 className="text-base text-slate-400 flex items-center"><FiMapPin className='me-1'/><span>Canberra, Australia</span></h6>
                                </div>
                            </div>
                            ...
                            <div className="grid lg:grid-cols-2 grid-cols-1 gap-6 mt-6">
                                <div className="group relative overflow-hidden rounded-md shadow dark:shadow-gray-800">
                                    ...
                                    <div className="flex items-center p-6 border-t border-gray-100 dark:border-gray-700">
                                        <Image src="/images/company/skype.png" className="size-12 shadow-md dark:shadow-gray-800 rounded-md p-2 bg-white dark:bg-slate-900" alt="" height={48} width={48} />

                                        <div className="ms-3">
                                             <h6 className="mb-0 font-semibold text-base">Skype</h6>
                                            <span className="text-slate-400 text-sm">Canberra, Australia</span>
                                        </div>
                                    </div>
                                </div>
