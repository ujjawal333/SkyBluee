...
import { CandidateList } from '../../components/Data';

export default function CandidateDetail({params}) {
    const resolvedParams = React.use(params);
    const id = resolvedParams.id;
    const data = CandidateList.find((candidate) => candidate?.id === parseInt(id));
                    ...
                    <div className="md:flex ms-4 -mt-12">
                        <div className="md:w-full">
                            <div className="relative flex items-end">
                                <Image src={data?.image} width={112} height={112} className="size-28 rounded-full shadow dark:shadow-gray-800 ring-4 ring-slate-50 dark:ring-slate-800" alt="" />
                                <div className="ms-4">
